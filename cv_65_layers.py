...
'./checkpoints/weights_11_2.h5': 512*512 image size: 
from data_keras_512 import load_train_data, load_test_data
...
'./checkpoints/weights_11_3_epoch_460.h5': 512*512 image size:
img[mask > 0.998] = (0, 0, 255)
from main_keras_65_layers import get_unet
"""
...
MODEL_PATH = './checkpoints/weights_11_3_epoch_47.h5'
N_EPOCH = 250
N_train_start = 0 
N_train_end = 1004
N_test_start = 1005
